...
**개념 단계의 엔터티는 8개입니다.** 논리 단계에서 「등록주소」·「관련지번」·「상세주소찾기」·「설정」·「버린조각」·「도로명읍면동」·「이름대응」·「주소대응」·「적재실행」·「적재파일」이 더해져 18개가 됩니다. 자세한 내용은 5절에 있습니다.
...
개념 모델의 엔터티 8개에 「등록주소」·「관련지번」·「상세주소찾기」·「설정」·「버린조각」·「도로명읍면동」·「이름대응」·「주소대응」·「적재실행」·「적재파일」을 더하면 논리 모델의 엔터티는 모두 18개입니다. **이 절에서는 자료형과 길이를 정하지 않습니다.**
...
**칼럼 117개를 전부 대조했습니다.** 물리명을 이루는 단어 82개 가운데 76개가 공통표준단어이고 6개가 프로젝트 신규 단어입니다.
