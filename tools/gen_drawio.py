...
TABLES = {'region': ('region · 행정구역',
 ...
 'addr_map': ('addr_map · 자리대응',
              [('bfr_road_nm_addr_mng_no', 'varchar(26)', 'PK', '옛 주소자리'),
               ('now_road_nm_addr_mng_no', 'varchar(26)', '', 'NOT NULL · 현재 주소자리'),
               ('bldg_mng_no', 'varchar(25)', '', 'NOT NULL · 이어 준 열쇠'),
