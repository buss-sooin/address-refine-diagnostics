...
RSN_ROWS = [
 ...
 ('UNIT_TOKEN_RESTORED','색인 기반 끊기','입력 오류','확인 권장','표지가 빠진 조각을 색인이 복원했다. A1의 응답 코드다','03-pipeline 4절 · 2절 ①-2'),
...
CODE_ROWS = [
 ...
 ('aptcpx_se','ref.address','공동주택구분','주소자리가 공동주택 자리인가','원천 코드값을 그대로 받는다','varchar(1)','원천이 값을 더하면 그대로 들어온다','원천'),
 ...
 ('idnty_src','svc.legacy_map','규명출처','옛 표기와 주소자리를 무엇으로 이었는가','E 외부조회 · I 내부판정','varchar(1)','E는 crt_src의 외부조회와 같은 글자다. 규명 수단이 늘면 값이 는다','우리'),
]
